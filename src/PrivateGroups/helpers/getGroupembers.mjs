...
export async function getGroupMemberAdmin(private_group_contract_admin, group_member) {
    const groupMemberField = await private_group_contract_admin.methods.get_group_member(group_member).simulate();
...
export async function getGroupMemberAlice(private_group_contract_alice, group_member) {
    const groupMemberField = await private_group_contract_alice.methods.get_group_member(group_member).simulate();
    console.log("Result of simulate():", groupMemberField);
...
export async function getGroupMemberBob(private_group_contract_bob, group_member) {
    const groupMemberField = await private_group_contract_bob.methods.get_group_member(group_member).simulate();
    console.log("Result of simulate():", groupMemberField);
